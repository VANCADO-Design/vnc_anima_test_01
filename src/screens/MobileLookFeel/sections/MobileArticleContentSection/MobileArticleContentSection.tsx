export const MobileArticleContentSection = (): JSX.Element => {
  return (
    <article className="flex flex-col items-start justify-center gap-6 px-3 py-0 relative self-stretch w-full flex-[0_0_auto]">
      ...
      <div className="flex flex-col items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
        <div className="aspect-[1.5] relative self-stretch w-full flex flex-col items-start gap-2">
          <img
        ...
        <article className="flex flex-col items-start gap-6 px-3 py-6 relative self-stretch w-full flex-[0_0_auto] bg-[#e6e6e6]">
          <div className="flex flex-col items-start gap-4 relative self-stretch w-full flex-[0_0_auto]">
            <div className="flex items-center gap-1 relative self-stretch w-full flex-[0_0_auto]">
              ...
              <p className="relative flex-1 mt-[-1.00px] font-project-paragraphs-small-p6-XXS font-[number:var(--project-paragraphs-small-p6-XXS-font-weight)] text-black text-[length:var(--project-paragraphs-small-p6-XXS-font-size)] tracking-[var(--project-paragraphs-small-p6-XXS-letter-spacing)] leading-[var(--project-paragraphs-small-p6-XXS-line-height)] [font-style:var(--project-paragraphs-small-p6-XXS-font-style)]">
                Overline z. B. für Kategorien
              </p>
            </div>

            <h3 className="relative self-stretch font-project-headlines-small-h5-XS font-[number:var(--project-headlines-small-h5-XS-font-weight)] text-black text-[length:var(--project-headlines-small-h5-XS-font-size)] tracking-[var(--project-headlines-small-h5-XS-letter-spacing)] leading-[var(--project-headlines-small-h5-XS-line-height)] [font-style:var(--project-headlines-small-h5-XS-font-style)]">
              Zwölf Boxkämpfer jagen Viktor quer über den großen Sylter Deich.
            </h3>
